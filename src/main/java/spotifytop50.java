 ...
 * We also used some resources from stack overflow, primarily, this link: https://stackoverflow.com/questions/2535723/try-catch-on-stack-overflows-in-java
...
public class spotifytop50 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("We encountered an error: " + e.getMessage()); // prints an error message if anything goes wrong
        }
    }

    /**
     * gets the top 50 songs the top 50 global Spotify playlist and allows the user to access information about a song by its position in the playlist.
    ...
    private static void getTopSongs(SpotifyApi spotifyApi) {
        ...
        try {
            ...
            while (continueSearch) {
                ...
                try {
                    ...
                    if (songNumber >= 1 && songNumber <= 50) {
                        ...
                        System.out.println("Thats not a correct input. Please enter a number between 1 and 50.");
                    }
            ...
            System.out.println("I have gathered the information of the songs you selected:");
            for (String info : songInfo) {
                System.out.println(info);
            }
        } catch (IOException | SpotifyWebApiException | ParseException e) {
            System.out.println("We encountered an error: " + e.getMessage()); // if encoutnered these stuff, print the error message.
        }
    }
}
